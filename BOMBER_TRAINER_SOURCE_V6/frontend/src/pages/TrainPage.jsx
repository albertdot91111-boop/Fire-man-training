...
export default function TrainPage() {
    ...
    const forestalComplete = isForestal && entries.slice(0, 3).every((entry) => parseTrainingTime(entry?.temps) > 0);
