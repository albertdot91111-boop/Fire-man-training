  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        await pb
          .collection("users")
          .authWithOAuth2Code("google", code, saved.codeVerifier, redirectURL);
        ...
        {error ? (
          <>
            ...
            <button
              ...
              className="mt-4 w-full min-h-[48px] rounded-xl bg-slate-900 text-white font-bold"
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-slate-500">Completant l'accés amb Google…</p>
          </div>
        )}
      </div>
    </div>
