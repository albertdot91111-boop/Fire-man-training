...
export default function HomePage() {
    ...
    return (
        <AppShell title="INICI">
            <Link to="/pautes-entrenador" className="mb-4 block rounded-3xl border border-orange-200 bg-orange-50 p-4 shadow-sm"><p className="text-xs font-black tracking-[0.18em] text-orange-700">PAUTES GUARDADES</p><div className="mt-1 flex items-center justify-between gap-3"><div><p className="text-lg font-extrabold text-slate-900">📋 Pautes del teu entrenador</p><p className="mt-1 text-sm font-medium text-slate-600">Consulta-les quan vulguis.</p></div><span className="text-xl font-black text-orange-700">→</span></div></Link>
            <Link to="/base-forca" className="mb-4 block rounded-3xl border border-orange-200 bg-orange-50 p-4 shadow-sm"><p className="text-xs font-black tracking-[0.18em] text-orange-700">BASE · FORÇA</p><div className="mt-1 flex items-center justify-between gap-3"><div><p className="text-lg font-extrabold text-slate-900">🏋️ Exercicis de força</p><p className="mt-1 text-sm font-medium text-slate-600">Registra pes i repeticions dels exercicis de l’entrenador.</p></div><span className="text-xl font-black text-orange-700">→</span></div></Link>
            <Link to="/nutricio" className="mb-4 block rounded-3xl border border-emerald-200 bg-emerald-50 p-4 shadow-sm"><p className="text-xs font-black tracking-[0.18em] text-emerald-700">NUTRICIÓ</p><div className="mt-1 flex items-center justify-between gap-3"><div><p className="text-lg font-extrabold text-slate-900">🍎 Menú setmanal</p><p className="mt-1 text-sm font-medium text-slate-600">Consulta la dieta i la suplementació.</p></div><span className="text-xl font-black text-emerald-700">→</span></div></Link>
