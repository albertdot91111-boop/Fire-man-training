...
const GROUPS = [
  {
    ...
    exercises: [['Step-up', 'Repeticions o temps'], ['Slam Ball', 'Pes (kg) + repeticions'], ['Farmer Carry', 'Pes (kg) + distància o temps'], ['Burpees', 'Repeticions o temps']],
  },
];
