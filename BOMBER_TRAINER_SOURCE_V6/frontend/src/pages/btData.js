...
export const PLANS = {
    ...
    forestal: [
        { name: 'Bloc 1', detail: 'Temps i descans registrats', fields: ['temps', 'descans'] },
        { name: 'Bloc 2', detail: 'Temps i descans registrats', fields: ['temps', 'descans'] },
        { name: 'Bloc 3', detail: 'Temps i descans registrats', fields: ['temps', 'descans'] },
    ],
    manteniment: [
