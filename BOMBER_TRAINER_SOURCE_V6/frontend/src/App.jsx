...
const HomePage = lazy(() => import('./pages/HomePage')); const LoginPage = lazy(() => import('./pages/LoginPage')); const TrainPage = lazy(() => import('./pages/TrainPage')); const ProgressPage = lazy(() => import('./pages/ProgressPage')); const ProfilePage = lazy(() => import('./pages/ProfilePage')); const AiPage = lazy(() => import('./pages/AiPageAuto')); const SettingsPage = lazy(() => import('./pages/SettingsPage')); const ActivitiesPage = lazy(() => import('./pages/ActivitiesPage')); const Register = lazy(() => import('./pages/Register')); const ForgotPassword = lazy(() => import('./pages/ForgotPassword')); const ResetPassword = lazy(() => import('./pages/ResetPassword')); const OAuthCallback = lazy(() => import('./pages/OAuthCallback'));
