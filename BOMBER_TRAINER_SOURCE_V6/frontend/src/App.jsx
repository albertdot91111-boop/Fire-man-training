...
function App(){const [legalAccepted,setLegalAccepted]=React.useState(hasLegalConsent);return <AuthProvider><QueryClientProvider client={queryClientInstance}><Router><ScrollToTop/><AuthenticatedApp/><AdminProgressEye/><NutritionDaily/><ProgressVisualFixes/></Router><Toaster/>{!legalAccepted && <LegalConsentGate onAccepted={() => setLegalAccepted(true)} />}</QueryClientProvider></AuthProvider>}
export default App;
