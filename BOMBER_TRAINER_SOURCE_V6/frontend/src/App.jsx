...
function App(){return <AuthProvider><QueryClientProvider client={queryClientInstance}><Router><ScrollToTop/><AuthenticatedApp/><NutritionDaily/></Router><Toaster/></QueryClientProvider></AuthProvider>}
export default App;
